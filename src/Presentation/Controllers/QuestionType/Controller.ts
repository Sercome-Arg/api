...
import ObjInterface from '../../../Domain/Entities/QuestionType/Interface'
import Serviceable from '../../../Domain/Entities/QuestionType/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/questionType'
	...
	@inject(TYPES.Validable) @named(TYPES.QuestionType) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.QuestionType) private schema: Schemable
	@inject(TYPES.QuestionTypeServiceableDomain) private service: Serviceable
