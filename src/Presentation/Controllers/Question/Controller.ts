...
import ObjInterface from '../../../Domain/Entities/Question/Interface'
import Serviceable from '../../../Domain/Entities/Question/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Question) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Question) private schema: Schemable
	@inject(TYPES.QuestionServiceableDomain) private service: Serviceable
