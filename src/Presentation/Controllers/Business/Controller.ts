...
import ObjInterface from '../../../Domain/Entities/Business/Interface'
import Serviceable from '../../../Domain/Entities/Business/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/business'
	...
	@inject(TYPES.Validable) @named(TYPES.Business) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Business) private schema: Schemable
	@inject(TYPES.BusinessServiceableDomain) private service: Serviceable
