...
import ObjInterface from '../../../Domain/Entities/QuestionQuiz/Interface'
import Serviceable from '../../../Domain/Entities/QuestionQuiz/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/questionQuiz'
	...
	@inject(TYPES.Validable) @named(TYPES.QuestionQuiz) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.QuestionQuiz) private schema: Schemable
	@inject(TYPES.QuestionQuizServiceableDomain) private service: Serviceable
