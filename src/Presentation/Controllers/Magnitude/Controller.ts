...
import ObjInterface from '../../../Domain/Entities/Magnitude/Interface'
import Serviceable from '../../../Domain/Entities/Magnitude/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/magnitude'
	...
	@inject(TYPES.Validable) @named(TYPES.Magnitude) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Magnitude) private schema: Schemable
	@inject(TYPES.MagnitudeServiceableDomain) private service: Serviceable
