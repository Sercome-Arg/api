...
import ObjInterface from '../../../Domain/Entities/Link/Interface'
import Serviceable from '../../../Domain/Entities/Link/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Link) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Link) private schema: Schemable
	@inject(TYPES.LinkServiceableDomain) private service: Serviceable
