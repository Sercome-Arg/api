...
import ObjInterface from '../../../Domain/Entities/Companyasd/Interface'
import Serviceable from '../../../Domain/Entities/Companyasd/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/companyasd'
	...
	@inject(TYPES.Validable) @named(TYPES.Companyasd) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Companyasd) private schema: Schemable
	@inject(TYPES.CompanyasdServiceableDomain) private service: Serviceable
