...
import ObjInterface from '../../../Domain/Entities/Unit/Interface'
import Serviceable from '../../../Domain/Entities/Unit/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/unit'
	...
	@inject(TYPES.Validable) @named(TYPES.Unit) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Unit) private schema: Schemable
	@inject(TYPES.UnitServiceableDomain) private service: Serviceable
