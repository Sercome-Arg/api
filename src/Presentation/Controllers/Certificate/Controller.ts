...
import ObjInterface from '../../../Domain/Entities/Certificate/Interface'
import Serviceable from '../../../Domain/Entities/Certificate/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/certificate'
	...
	@inject(TYPES.Validable) @named(TYPES.Certificate) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Certificate) private schema: Schemable
	@inject(TYPES.CertificateServiceableDomain) private service: Serviceable
