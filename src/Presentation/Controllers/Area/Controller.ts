...
import ObjInterface from '../../../Domain/Entities/Area/Interface'
import Serviceable from '../../../Domain/Entities/Area/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/area'
	...
	@inject(TYPES.Validable) @named(TYPES.Area) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Area) private schema: Schemable
	@inject(TYPES.AreaServiceableDomain) private service: Serviceable
