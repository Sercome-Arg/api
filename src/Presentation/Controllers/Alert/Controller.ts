...
import ObjInterface from '../../../Domain/Entities/Alert/Interface'
import Serviceable from '../../../Domain/Entities/Alert/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/alert'
	...
	@inject(TYPES.Validable) @named(TYPES.Alert) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Alert) private schema: Schemable
	@inject(TYPES.AlertServiceableDomain) private service: Serviceable
